...
The release pipeline is driven by `release-local.sh` (generated by `make configure-release`). It has 8 pipeline steps and 3 utility commands. Individual steps can be run selectively:
