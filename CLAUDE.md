...
After completing significant work (before committing, end of session), run `make sync-private` to keep the private repo current. If the private repo doesn't exist yet, the target auto-initializes it.
