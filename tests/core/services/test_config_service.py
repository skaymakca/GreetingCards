"""Tests for app.core.services.config_service module."""
...
class TestConfigService:
    ...
    @patch("app.core.services.config_service.get_api_key", return_value="sk-test")
    def test_get_api_key(self, mock_get):
        assert ConfigService.get_api_key() == "sk-test"
        mock_get.assert_called_once()

    @patch("app.core.services.config_service.save_api_key")
    ...
    @patch("app.core.services.config_service.get_api_key", return_value=None)
    def test_has_api_key_false(self, mock_get):
        assert ConfigService.has_api_key() is False

    @patch("app.core.services.config_service.get_ai_model", return_value="claude-sonnet-4-6")
    def test_get_ai_model(self, mock_get):
        assert ConfigService.get_ai_model() == "claude-sonnet-4-6"
        mock_get.assert_called_once()

    @patch("app.core.services.config_service.save_ai_model")
