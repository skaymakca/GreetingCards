...
1. Drag **Greeting Cards** to your Applications folder.
2. Open the app from Applications or Launchpad.
3. Click **Add Files** to load your card PDFs — each card is automatically scanned for text.
...
- An Anthropic API key for AI-powered name detection
